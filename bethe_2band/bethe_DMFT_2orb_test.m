function bethe_DMFT_2orb (parfn, varargin)
try 
    ...
    for it = (1:numel(partot))
        ...
        resname = go(['/local/MuNRG/mybin/bethe_2band/out/Bethe_test_',par2str('U',U,'mu',mu,'T',T,'Lambda',Lambda,'Nkeep',Nkeep,'nz',nz)]);
		...
		numCorr = 3
		D = 2
		get_Bethe_DMFT_2orb(U,mu,iter,numCorr,D,resname,RhoV2init,T,Lambda,Nkeep,nz)
		%%%
