function backward_jljs (parfn, varargin)
try
    ...
    for it = (1:numel(partot))
        ...
        resname = go(['/local/MuNRG/mybin/bethe_2band/AA_kanamori/out/backward/Bethe_jljs_',par2str('U',U,'Jl',Jl,'Js',Js,'T',T,'Lambda',Lambda,'Nkeep',Nkeep,'nz',nz,'alphaL',alphaL,'nd',nd,'D',D)]);
		...
		%%%
		RVs = '/home/dinnercha/local/MuNRG/mybin/bethe_2band/AA_kanamori/params/RV2s/'
		disp('++++++++++++++++++++++++++++++++++++++')
		...
		numCorr = 3;
		D = 1;
		get_Bethe_DMFT_jljs_AA(U,Js,Jl,mu,iter,numCorr,D,resname,RhoV2init,T,Lambda,Nkeep,nz,alphaL,nd)
		%%%
