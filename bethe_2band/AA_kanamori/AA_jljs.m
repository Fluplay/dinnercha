function AA_jljs (parfn, varargin)
try
    ...
    for it = (1:numel(partot))
        ...
        resname = go(['/local/MuNRG/mybin/bethe_2band/AA_kanamori/out/Bethe_jljs_',par2str('U',U,'Jl',Jl,'Js',Js,'T',T,'Lambda',Lambda,'Nkeep',Nkeep,'nz',nz,'alphaL',alphaL,'nd',nd,'D',D)]);
