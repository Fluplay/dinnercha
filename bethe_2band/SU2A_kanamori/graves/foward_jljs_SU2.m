function foward_jljs_SU2 (parfn, varargin)
try
    ...
    for it = (1:numel(partot))
        ...
        resname = go(['/local/MuNRG/mybin/bethe_2band/SU2A_kanamori/out/foward/Foward_Bethe_jljs_',par2str('U',U,'Jl',Jl,'Js',Js,'T',T,'Lambda',Lambda,'Nkeep',Nkeep,'nz',nz,'alphaL',alphaL,'nd',nd,'D',D)]);
		...
		save([RVs,'U',num2str(U),'_foward.mat'])
